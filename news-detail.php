...
<head>
    ...
    <meta name="description" content="Magazine Clinic, Hospital, Pine Avenue">
    <meta name="author" content="Mohammed Alhassan">
    <title>Magazine Clinic, Pine Avenue</title>
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link href="css/bootstrap-icons.css" rel="stylesheet">
    <link href="css/templatemo-kind-heart-charity.css" rel="stylesheet">
</head>
<body>
    <header class="site-header" style="background-color: #0023BD;">
        ...
        <div class="container">
            <a class="navbar-brand" href="index.php">
                ...
                <span style="color:red">
                    <b>Magazine</b> Clinic
                    <small>Your health, our concern</small>
                </span>
            </a>
